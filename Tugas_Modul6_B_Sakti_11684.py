...
model = load_model(r'/Users/saktiyoga/Development/University/Semester 5/PMDPM/Tugas6_B_11684/model_mobilenet.h5')
...
# Streamlit UI
st.title("Prediksi Kematangan Buah Naga - 1684")  # 4 digit pm terakhir
